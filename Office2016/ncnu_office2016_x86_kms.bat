...
@echo Before you start this batch, please connect to intranet of NCNU, or it will fail.
@echo:
@pause
...
@echo:
@echo If you see ^<Product activation successful^> on the screen, you are now successful.
@pause
) ELSE (
@echo:
